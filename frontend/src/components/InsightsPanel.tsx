    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden">
      <div className="p-6 border-b border-slate-100">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-slate-900 mb-1">Real-Time Insights</h3>
            <p className="text-sm text-slate-600">AI-powered analysis updated 2 minutes ago</p>
          </div>
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Performance Trend */}
        <div>
          <h4 className="font-medium text-slate-900 mb-4">Performance Trend</h4>
